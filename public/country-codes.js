// COUNTRY_CODES: one entry per country.
// name = display name, iso = 2-letter country code (used to build the flag emoji),
// dial = international calling code (E.164 style).
//
// This is static reference data — it basically never changes, so it's safe
// to keep as a plain hardcoded array like this rather than fetching it
// from anywhere.
